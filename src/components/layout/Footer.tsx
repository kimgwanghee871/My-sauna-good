      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">G-Won AI</span>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              AI가 만들어주는 전문적인 사업계획서. 정부지원, 투자유치, 대출용 템플릿으로 10분 만에 완성하세요.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/templates/government" className="text-gray-400 hover:text-white transition-colors">정부지원용</Link></li>
              <li><Link href="/templates/investment" className="text-gray-400 hover:text-white transition-colors">투자유치용</Link></li>
              <li><Link href="/templates/loan" className="text-gray-400 hover:text-white transition-colors">대출용</Link></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6">
            <p className="text-gray-400 text-sm">&copy; 2024 G-Won AI. All rights reserved.</p>
          ...
          <div className="mt-4 md:mt-0">
            <p className="text-gray-400 text-sm">사업자등록번호: 123-45-67890 | 대표: 김지원</p>
          </div>
        </div>
      </div>
    </footer>
